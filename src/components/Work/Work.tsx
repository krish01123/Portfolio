...
export default function SelectedWork() {
  return (
    <section className="bg-black text-white px-4 py-12 sm:px-6 sm:py-16 md:px-8 md:py-20 lg:px-12 lg:py-24 xl:px-16 2xl:px-24 3xl:px-40 3xl:py-32">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4 md:gap-5 lg:gap-6 2xl:gap-8 3xl:gap-10 ">
        {projects.map((project) => (
          <Link key={project.href} href={project.href}>
            <article className="relative group overflow-hidden rounded-lg bg-zinc-900 aspect-[4/5] sm:aspect-[16/12] md:aspect-[16/10] lg:aspect-[16/10] 2xl:aspect-[16/9] cursor-pointer">
              <Image
                src={project.image}
                alt={project.title}
                fill
