...
export default function NovaPage() {
  const cards = [
    {
      title: "Challenge",
      text: "Nova needed a premium digital presence that showcased its futurisitc product design while maintaing a clean and immersive user experience. The previous presentation lacked visual impact and did not effectively communicate the product's value.",
    },
    {
      title: "Goal",
      text: "Create a modern product showcase that combines strikung visuals, smooth interactions, and luxury-inspired aesthetic. The experience needed to feel innovative, responsive, and aligned with Nova's cutting-edge identity.",
    },
    {
      title: "Result",
      text: "The final website delivers a visually engaing experience that highlights Nova's design language through bold imagery, elegant typography, and seamless navigation. The project successfully strengthened the brand's online presence and improved user engaement.",
    },
  ];
  return (
    <>
